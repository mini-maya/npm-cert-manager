...
@router.get("/settings", response_model=AppSettings, dependencies=[Depends(require_session)])
...
@router.put("/settings", response_model=AppSettings, dependencies=[Depends(require_session)])
def update_settings(payload: SettingsIn) -> AppSettings:
